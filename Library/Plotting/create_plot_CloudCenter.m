function create_plot_CloudCenter(analyVar,indivDataset)
...
for basenameNum = 1:analyVar.numBasenamesAtom
    ...
    CntrX = indivDataset{basenameNum}.cntrX(1,:);
    CntrY = indivDataset{basenameNum}.cntrY(1,:);
    
%% Plot of radius in X & Y
%%%%%%%-----------------------------------%%%%%%%%%%
    figNum = analyVar.figNum.cloudcenter; 
    radLabel = {'Cloud XCntr [um]', 'Cloud YCntr [um]'}; 
